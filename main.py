...
def attack(char_name: str, char_class: str) -> str:
    """Это функция отвечает за атаку персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Это функция отвечает за защиту персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Это функция отвечает за применение умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Это функция отвечает за использования навыка героя."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Данная функция запрашивает у игрока данные."""
    approve_choice: str = ''
    char_class: str = ''
